...
%declare INPUT_PATH 'D:/hadoop/PigData/tstat-sample.txt';
%declare OUTPUT_PATH 'D:/hadoop/PigData/Output/';


-- Load input data from local input directory
A = LOAD '$INPUT_PATH' using PigStorage(' ') AS (ip_c:chararray,
port_c:int,
packets_c:int,
rst_c:int,
ack_c:int,
...
-- TODO: Store output data in D:/hadoop/PigData/Output/
